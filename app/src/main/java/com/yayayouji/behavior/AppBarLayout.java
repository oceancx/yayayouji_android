...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.AppBarLayout,
        ...
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(android.support.design.R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(
                    this, a.getDimensionPixelSize(android.support.design.R.styleable.AppBarLayout_elevation, 0));
        }
        a.recycle();
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = mCollapsible ? android.support.design.R.attr.state_collapsible : -android.support.design.R.attr.state_collapsible;
        extraStates[1] = mCollapsible && mCollapsed
                ? android.support.design.R.attr.state_collapsed : -android.support.design.R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, android.support.design.R.styleable.AppBarLayout_Layout);
            mScrollFlags = a.getInt(android.support.design.R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(android.support.design.R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(
                        android.support.design.R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
